...
const Home = () => {
  return (
    <div className="container">
      <h2 className="headingtop">Abstract</h2>
      ...
      <p className="keywords"><strong>Key words:</strong> Edge Computing, Latency Reduction, Real-time Processing, Cloud-Edge Integration</p>
      ...
      <div className="imageContainer">
        <img src={process.env.PUBLIC_URL + '/edge-computing.png'} alt="Edge Computing Illustration" className="image" />
        <p className="caption">Figure 1: Edge Computing - Faster Data Processing</p>
      </div>
    </div>
  );
};
